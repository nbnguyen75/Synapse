...
export const companionSettingsSchema = z.object({
  responseLength: z.enum(COMPANION_SETTINGS_RESPONSE_LENGTH).default('balanced'),
...
export type CompanionSettingsFormInput = z.input<typeof companionSettingsSchema>;
